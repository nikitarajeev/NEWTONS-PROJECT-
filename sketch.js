...
var roof;
var rope1,rope1,rope3,rope4,rope5;
...
function setup() {
	...
	bob1 = new Bob(325,500,35);
	bob2 = new Bob(360,500,35);
	bob3 = new Bob(395,500,35);
	bob4 = new Bob(430,500,35);
	bob5 = new Bob(465,500,35);

	roof = new Roof(390,300,250,10);
